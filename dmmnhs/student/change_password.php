...
$page_title = 'Student Change Password';
...
<form method="POST" class="stack-form auth-form">
    ...
    <label class="subtle"><input type="checkbox" id="show-pass-student"> <span>Show passwords</span></label>
...
<script>
document.getElementById('show-pass-student').addEventListener('change', function(){
