...
<form method="POST" class="stack-form auth-form">
    ...
    <label class="subtle"><input type="checkbox" id="show-pass-admin"> <span>Show passwords</span></label>
...
<script>
document.getElementById('show-pass-admin').addEventListener('change', function(){
