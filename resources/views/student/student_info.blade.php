@php
    ...
    $fields = [
        ...
        'Account Status' => $info->status ?? 'N/A',
        'Sex' => $info->sex ?? 'N/A',
        'Birthday' => $info->birthday ?? 'N/A',
        'Age' => (string) ($info->age ?? 'N/A'),
        'Grade Level' => (string) ($info->grade_level ?? 'N/A'),
    ];
    ...
    <div class="relative mx-auto max-w-[760px] pb-4 pt-2">
        ...
        <div class="mb-8 flex flex-wrap items-center justify-between gap-3">
            <div class="group relative flex items-center gap-2.5">
                ...
                <div class="relative">
                    <h2 class="m-0 bg-gradient-to-r from-[#0a1633] via-[#0018f9] to-[#0080fe] bg-clip-text text-[22px] font-extrabold tracking-tight text-transparent">STUDENT INFO</h2>
                ...
                <div class="card-content">
                    @if (! $hasProfile)
                        <div class="alert-message">
                            <p>Your student profile is not yet complete. Contact admin to complete your personal info.</p>
                        </div>
                    @endif
                    ...
                    @if (!empty($advisoryFields))
                        <div class="information-section">
                            <div class="section-title">Advisory Information</div>
                            <div class="info-grid">
                                @foreach ($advisoryFields as $label => $value)
                                    <div class="info-item">
                                        <div class="label">{{ $label }}</div>
                                        <div class="value">{{ $value }}</div>
                                    </div>
