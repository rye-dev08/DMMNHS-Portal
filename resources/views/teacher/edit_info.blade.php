    ...
    <form method="POST" action="{{ route('teacher.info.update') }}" data-validate
        ...
        <div class="mb-5 flex items-center gap-3 border-b border-[#0018f9]/10 pb-4">
            ...
            <div>
                ...
                <p class="m-0 text-[12.5px] text-slate-500">Update your name and email below.</p>
            </div>
        </div>
        ...
        <div class="mt-4 rounded-xl border border-[#0018f9]/10 bg-[#eaf3ff]/60 p-3.5 text-[12.5px] text-[#0a1633]/75">
            <span class="font-semibold">Username:</span> <span class="font-mono">{{ $user->username }}</span>
